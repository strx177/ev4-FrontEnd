...
function MascotasDetail() {
  ...
  const eliminarComentario = async (idComentario) => {
    ...
    try {
      await mascotasApi.delete(`/comentarios/${idComentario}/`);

      setComentarios((prev) =>
        prev.filter((comentario) => comentario.id !== idComentario),
      );
      ...
      {fetchError ? (
        <div className="text-center bg-white p-5 rounded-4 shadow-sm">
          ...
          <p className="text-muted fs-5">
            Mascota no encontrada o ha sido eliminada.
          </p>
          <Link
            to="/mascotas"
        ...
        <div className="row g-4 justify-content-center">
          <div className="col-lg-8">
            ...
            <div className="card shadow-sm rounded-4 border-0 mb-5">
              <div className="position-relative">
                ...
                <div className="position-absolute top-0 end-0 p-3">
                  <span
                    className={`badge ${getEstadoClase(mascota?.estado)} fs-6 shadow-sm rounded-pill px-3 py-2`}
                  >
            ...
            <div className="card shadow-sm rounded-4 border-0 p-4 p-lg-5">
              ...
              <div className="mb-5">
                {comentarios.filter((c) => c.mascota === Number(id)).length ===
                0 ? (
              ...
              <div className="border-top pt-4">
                ...
                <form onSubmit={handleSubmitComentario}>
                  <div className="mb-3">
                    <label
                      htmlFor="autor"
                      className="form-label text-muted fw-medium small"
                    >
                      Nombre
                    </label>
                    <input
                  ...
                  <button
                    type="submit"
                    className="btn btn-info text-white rounded-pill px-4 py-2 fw-medium shadow-sm"
                    disabled={submitting}
                  >
                    {submitting ? (
                      <>
